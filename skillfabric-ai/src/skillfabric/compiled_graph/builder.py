...
def build_graph(config: BuildConfig, *, dependencies: _BuildDependencies | None = None) -> BuildResult:
    ...
    with workspace.lock(), llm_usage_context(log_path=usage_log_path, metadata={"build_id": build_id}):
        ...
        stats = {
            ...
            "canonicalization_deterministic_count": canonicalization.deterministic_count,
            ...
            "canonicalization_warnings": list(canonicalization.warnings),
        ...
        workspace.write_json(
            workspace.status_path,
            {
                ...
                "canonicalization_deterministic_count": stats["canonicalization_deterministic_count"],
                ...
                "canonicalization_warnings": stats["canonicalization_warnings"],
    ...
    workspace.write_json(
        workspace.reports_dir / "build_summary.json",
        {
            ...
            "canonicalization": {
                ...
                "deterministic_count": stats.get("canonicalization_deterministic_count", 0),
                ...
                "warnings": stats.get("canonicalization_warnings", []),
