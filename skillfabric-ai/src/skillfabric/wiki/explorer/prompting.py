...
def render_system_prompt(context: ExplorerPromptContext) -> str:
    ...
    return (
        ...
        "# Workflow\n\n"
        "Step 1: Read index.md first. Treat its Candidate Skill Cards as the primary routing map.\n"
        "Step 2: Understand the task query as capability requirements: domain, input artifact types, output artifact types, required operations, constraints, validation needs, and support capabilities.\n"
        "Step 3: Map each requirement to candidate cards in index.md. Prefer candidates whose summary, use_when, requires, produces, tools, or workflow hints directly cover a requirement.\n"
        ...
        "- First decompose the task query into capability facets: task domain, input artifact types, output artifact types, required operations, constraints, validation needs, and likely support capabilities.\n"
...
def render_user_prompt(context: ExplorerPromptContext) -> str:
    ...
    return (
        ...
        "Read index.md first. Prefer candidate cards and generated skill-page header sections before raw Source text. "
