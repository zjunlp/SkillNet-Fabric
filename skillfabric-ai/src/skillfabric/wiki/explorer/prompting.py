...
def render_system_prompt(context: ExplorerPromptContext) -> str:
    ...
    return (
        ...
        "Step 2: Understand the task query as capability requirements: input artifact types, output artifact types, required operations, constraints, validation needs, and support capabilities.\n"
...
def render_user_prompt(context: ExplorerPromptContext) -> str:
    ...
    return (
        ...
        "Read index.md first. Prefer candidate cards and generated skill-page "
